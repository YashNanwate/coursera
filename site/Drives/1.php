				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">Home<i>Get the Overview of the Site</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
								<a href="index.php">Placement Detail<i>About Placement</i></a>
							</li>
							<li class="hvr-sweep-to-bottom active">
								<a href="about.php">Recruiters<i>About Companies</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="products.php">Study Material<i>Study Material</i></a>
							</li>							
							<li class="hvr-sweep-to-bottom">
								<a href="C:\Users\ADMIN\Desktop\PROJECT\Homepage\contact_us.html">Contact Us<i>Contact</i></a>
							</li>
