        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.projectworlds.in">YCCE</a>
                </div>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>TRAINING & PLACEMENT MANAGEMENT CELL</h1>
                    <hr>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>NAGPUR, MAHARASTHRA</p>
					<p>WANADONGRI,NAGPUR,India</p>
					<a href="mailto:tnpgrp8@gmail.com">tnpgrp8@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>GROUP 08 &copy; 2021 | Developed by Group 8</p>
				</div>
